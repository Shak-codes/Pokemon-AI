...
// =============================================================================
// GENERATION 1 TYPE CHART (Red/Blue/Yellow)
// =============================================================================
// Key differences from modern:
// - No Dark, Steel, or Fairy types
// - Ghost has no effect on Psychic (bug in original game)
// - Bug is super effective vs Poison (2x)
// - Poison is super effective vs Bug (2x)
// - Ice deals neutral damage to Fire (1x)
// =============================================================================

std::map<std::pair<Type, Type>, double> gen1TypeMatchups = {
    // NORMAL
    ...
    {{Type::Ice, Type::Fire}, 1.0},  // Gen 1: Neutral (not 0.5x like later gens)
    ...
    {{Type::Poison, Type::Bug}, 2.0},  // Gen 1: Poison is 2x vs Bug
    ...
    {{Type::Bug, Type::Poison}, 2.0},  // Gen 1: Bug is 2x vs Poison
    ...
    {{Type::Ghost, Type::Psychic}, 0.0},  // Gen 1 bug: Ghost has no effect on Psychic
...
// =============================================================================
// MODERN TYPE CHART (Generation 6+, includes Fairy type)
// =============================================================================
// Includes all 18 types: Normal, Fire, Water, Electric, Grass, Ice, Fighting,
// Poison, Ground, Flying, Psychic, Bug, Rock, Ghost, Dragon, Dark, Steel, Fairy
// =============================================================================

std::map<std::pair<Type, Type>, double> modernTypeMatchups = {
    // NORMAL
    {{Type::Normal, Type::Normal}, 1.0},
    {{Type::Normal, Type::Fire}, 1.0},
    {{Type::Normal, Type::Water}, 1.0},
    ...
    // ICE
    {{Type::Ice, Type::Normal}, 1.0},
    {{Type::Ice, Type::Fire}, 0.5},  // Modern: Ice is resisted by Fire
    {{Type::Ice, Type::Water}, 0.5},
    {{Type::Ice, Type::Electric}, 1.0},
    {{Type::Ice, Type::Grass}, 2.0},
    {{Type::Ice, Type::Ice}, 0.5},
    ...
    {{Type::Poison, Type::Flying}, 1.0},
    {{Type::Poison, Type::Psychic}, 1.0},
    {{Type::Poison, Type::Bug}, 1.0},  // Modern: Poison is neutral vs Bug
    {{Type::Poison, Type::Rock}, 0.5},
    {{Type::Poison, Type::Ghost}, 0.5},
    {{Type::Poison, Type::Dragon}, 1.0},
    ...
    {{Type::Bug, Type::Ice}, 1.0},
    {{Type::Bug, Type::Fighting}, 0.5},
    {{Type::Bug, Type::Poison}, 0.5},  // Modern: Bug is resisted by Poison
    {{Type::Bug, Type::Ground}, 1.0},
    {{Type::Bug, Type::Flying}, 0.5},
    {{Type::Bug, Type::Psychic}, 2.0},
    {{Type::Bug, Type::Bug}, 1.0},
    ...
    {{Type::Ghost, Type::Ground}, 1.0},
    {{Type::Ghost, Type::Flying}, 1.0},
    {{Type::Ghost, Type::Psychic}, 2.0},  // Modern: Ghost is super effective vs Psychic
    {{Type::Ghost, Type::Bug}, 1.0},
    {{Type::Ghost, Type::Rock}, 1.0},
    {{Type::Ghost, Type::Ghost}, 2.0},
    {{Type::Ghost, Type::Dragon}, 1.0},
...
using TypeMatchupMap = std::map<std::pair<Type, Type>, double>;

/**
 * Get type effectiveness multiplier from a specific type chart.
 * @param matchups The type matchup map to use (gen1TypeMatchups or modernTypeMatchups)
 ...
 */
inline double getTypeEffectiveness(const TypeMatchupMap& matchups,
                                   Type attacker,
                                   Type defender) {
  auto it = matchups.find({attacker, defender});
  if (it != matchups.end()) {
    return it->second;
  }
  return 1.0;
...
/**
 * Get type effectiveness for dual-type Pokemon from a specific type chart.
 * @param matchups The type matchup map to use (gen1TypeMatchups or modernTypeMatchups)
 * @param attacker The type of the attacking move
 * @param defenderTypes Vector of defender's types (1 or 2 types)
 * @return The combined effectiveness multiplier
 */
inline double getTypeEffectiveness(const TypeMatchupMap& matchups,
                                   Type attacker,
                                   const std::vector<Type>& defenderTypes) {
  double effectiveness = 1.0;
  for (const Type& defType : defenderTypes) {
    effectiveness *= getTypeEffectiveness(matchups, attacker, defType);
  }
